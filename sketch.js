  ...
  for (var i = 0; i < playerArrows.length; i++) {
    ...
    if (
     ...
     if(computerArcherLife<=0){
       ...
       Matter.Body.setPosition(computer.body,{x:width-180,y:computer.body.position.y});
     }
    }
  }
}
  ...
  for (var i = 0; i < computerArrows.length; i++) {
    ...
    if (
      ...
      if(playerArcherLife<=0){
        ...
        Matter.Body.setPosition(computer.body,{x:width-100,y:player.body.position.y});
      }
     }
  }
}
